...
/**
 * The refresh token presented to renew a session (SRS 3.2.3). Ending one uses {@link LogoutRequest},
 * which carries the same token and optionally the device being signed out of.
 *
 ...
 * a body.
 *
 * <p>Rule: SRS 3.2.3, UC-03; message MSG01; TECHNICAL_DESIGN 7.15.
 *
